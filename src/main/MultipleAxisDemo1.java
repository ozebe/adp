...
public class MultipleAxisDemo1 extends ApplicationFrame {
    ...
    private static JFreeChart createChart() {
        ...
        XYDataset dataset1 = createDataset("Temperatura", 100.0, new Minute(),
                200);
       ...
       // XYDataset dataset2 = createDataset("Series 2", 1000.0, new Minute(),
        ...
        // AXIS 3
        NumberAxis axis3 = new NumberAxis("Pressão");
        plot.setRangeAxis(2, axis3);

        XYDataset dataset3 = createDataset("Pressão atmosférica", 10000.0, new Minute(),
                170);
